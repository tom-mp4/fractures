...
<template>
  <section class="LegalContent">
    ...
    <p>
      ...
      site Séances Fractures l'identité des différents intervenants dans le cadre de
    ...
    <div class="textBlock">
      ...
      <p>
        Le présent site, accessible à l’URL seancesfractures.fr (le « Site »), est édité par :
