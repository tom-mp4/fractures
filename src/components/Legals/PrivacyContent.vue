...
<template>
  <section class="LegalContent">
    <div id="title">
      ...
      <p>
        Mise à jour le 4/01/2025
      </p>
    </div>
    <p>
      Le site web saencesfractures.fr est détenu par <router-link to="/legal">Paraleclypse SAS
    ...
    <div>
      ...
      <p>
        Lorsque vous visitez servicesfractures.fr, nous recueillons automatiquement certaines
